...
class Membre implements UserInterface, \Serializable 
{
	...
	/*CODE AJOUTER POUR SECURITE*/
	//private $roles=>array("ROLE_UTIL");
    ...
    public function serialize() {
        return serialize(array( $this->id, $this->identifiant, $this->password));
    }
    public function unserialize($serialized) {
        list( $this->id, $this->identifiant, $this->password) = unserialize($serialized);
    }
